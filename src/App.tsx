...
const PageLoader = () => (
  <div className="min-h-[60vh] flex flex-col items-center justify-center text-slate-500">
    ...
    <p className="font-medium animate-pulse">Loading wholesale catalog...</p>
  </div>
);
    ...
    <HelmetProvider>
      <Router>
        <div className="min-h-screen bg-slate-50 flex flex-col">
          ...
          <a
            href="https://wa.me/918595551669?text=Hi, I am interested in wholesale bags. Please share your catalog."
            target="_blank"
